...
#     """
#     Tải toàn bộ nội dung thư mục Google Drive (folder_id hoặc URL)
...
#     """
#     Duyệt tất cả thư mục con (Healthy, Diseased, ...)
#     và đổi tên ảnh theo mẫu <ten_thu_muc><so_thu_tu>.<duoi_anh>.
#     """
...
#     # 🔧 Cấu hình tại đây
#     DRIVE_URL = "https://drive.google.com/drive/folders/1tDYQhEZy_WovYko2swNTZcbG8XAC68FQ?usp=sharing"  # link thư mục chứa ảnh raw
